...
void displayPH(const float pH, const float convertedPH, const ulong asOf) {
...
//   Serial.begin(115200);  // set serial monitor to 115200 baud rate

//   Serial.println(F("---------------------- Robo-Tank pH Circuit Test Sketch ----------------------"));
//   Serial.println(F("------------------------------------------------------------------------------"));
//   Serial.println(F(""));

//   float pH = 0;
//   pH = getPH();  // this function will get the current pH
// }

// void loop() {
//   // put your main code here, to run repeatedly:
//   delay(4000);  // wait 4 seconds until we read pH
//   float pH = 0;
//   pH = getPH();  // this function will get the current pH
// }
